...
## Các Module Mới Đã Bổ Sung

### 1. Sản Phẩm Theo Từng Danh Mục

Backend sử dụng API:

```text
GET /api/products?category=Đồng hồ cơ&page=1&limit=4
```
...
### 2. Top 10 Bán Chạy Và Xem Nhiều

Backend sử dụng API:

```text
GET /api/products/top?type=sold&page=1&limit=10
GET /api/products/top?type=views&page=1&limit=10
```

Frontend sử dụng:

```text
frontend/src/components/HorizontalProductCarousel.jsx
frontend/src/store/productsSlice.js
frontend/src/pages/App.jsx
```
