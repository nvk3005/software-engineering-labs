import { Camera, Gift, Save, Upload } from "lucide-react";
  ...
  return (
    <form className="profile-panel" onSubmit={submit}>
      ...
      <div className="loyalty-points">
        <p><Gift size={16} /> Điểm tích lũy</p>
        <strong>{Number(user?.loyaltyPoints || 0)} điểm</strong>
        <span>Đánh giá sản phẩm đã mua để nhận thêm điểm cho lần mua sau.</span>
      </div>
      <label>
        Họ tên
